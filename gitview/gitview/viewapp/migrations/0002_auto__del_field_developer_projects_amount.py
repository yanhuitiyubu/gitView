...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Developer.projects_amount'
        db.delete_column(u'viewapp_developer', 'projects_amount')


    def backwards(self, orm):
        # Adding field 'Developer.projects_amount'
        db.add_column(u'viewapp_developer', 'projects_amount',
