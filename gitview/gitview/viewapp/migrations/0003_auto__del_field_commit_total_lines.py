...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Commit.total_lines'
        db.delete_column(u'viewapp_commit', 'total_lines')


    def backwards(self, orm):
        # Adding field 'Commit.total_lines'
        db.add_column(u'viewapp_commit', 'total_lines',
