...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CodeHost'
        db.create_table(u'viewapp_codehost', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('commit_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('code_host', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'viewapp', ['CodeHost'])

        # Adding field 'Commit.commit_url'
        db.add_column(u'viewapp_commit', 'commit_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.code_host'
        db.add_column(u'viewapp_project', 'code_host',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['viewapp.CodeHost'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CodeHost'
        db.delete_table(u'viewapp_codehost')

        # Deleting field 'Commit.commit_url'
        db.delete_column(u'viewapp_commit', 'commit_url')

        # Deleting field 'Project.code_host'
        db.delete_column(u'viewapp_project', 'code_host_id')
    ...
    models = {
        ...
        u'viewapp.codehost': {
            'Meta': {'object_name': 'CodeHost'},
            'code_host': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'commit_url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
        ...
        u'viewapp.commit': {
            ...
            'commit_url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        u'viewapp.project': {
            ...
            'code_host': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['viewapp.CodeHost']", 'null': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
